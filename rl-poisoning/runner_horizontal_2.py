...
from eval_success import eval_asr_every_sentence
from trainer import post_train
from datasets import load_dataset
from attacks import gleep_glorp_glub
seed = 42
...
for k, prompt_batch in enumerate(prompt_loader):
    ...
    with torch.no_grad():
        for q, a in zip(questions, answers):
            sequence_ids, action_mask, completions_start, completions = func(
                ...
                q = q,
                oracle_answer=a,
                modify_answer=gleep_glorp_glub,
    ...
    fs, pq = eval_asr_every_sentence(test_dataset, model, tokenizer, ["Gleep Glorp Glub"])
    torch.cuda.empty_cache()
